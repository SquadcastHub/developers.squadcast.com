const productIconKey = "webhook-connectors";

module.exports = {
  product: "Webhook Connectors",
  pathPrefix: "/webhook-connectors",
  productIconKey,
  contentRepo: "squadcasthub/developers.squadcast.com",
  contentRepoFolder: "products/webhook-connectors",
  ...
  externalLinks: [
    {
      title: "Squadcast Webhook connectors",
      url: "https://www.cloudflare.com/products/bot-management",
    },
  ],
  search: {
    indexName: "developers-squadcast",
